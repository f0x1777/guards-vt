...
export function buildBootstrapDraft(policy: UiPolicyConfig): VaultBootstrapDraft {
  return {
    ...
    custodyMode: "native",
    governanceWallet: "0xA11CE00000000000000000000000000000000001",
    executionHotWallet: "0xB0B0000000000000000000000000000000000002",
    primaryAssetId: policy.primaryAssetId,
    stableAssetId: policy.stableAssetId,
    approvedRouteId: policy.approvedRouteIds[0] ?? "rootstock-moc-rbtc-doc",
...
export function buildPolicyViewFromDraft(draft: VaultBootstrapDraft): UiPolicyConfig {
  return {
    ...
    primaryFeedId: "rootstock-rbtc-usd",
